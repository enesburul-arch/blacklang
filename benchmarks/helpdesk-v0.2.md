# SupportDesk Template Benchmark v0.2

## Purpose

This benchmark records the first reusable helpdesk app template for BlackLang.

The goal is to measure whether one compact `.black` source can describe a realistic support application pattern with auth, roles, relations, workflows, validation, API contracts, and generated web behavior.
...
```text
Metric                 Value
BlackLang source lines 423
Generated files        55
Generated lines        12466
Entities               8
Pages                  8
Roles                  4
Workflows              2
...
This is a template benchmark, not a claim that every helpdesk feature is complete in v0.1.
