...
Those features belong to future frontend logic and event phases.
...
```text
BlackLang v0.2 can describe and generate useful CRUD/admin-style web applications with auth, roles, relations, workflow, validation, i18n labels, inline UI intent, page view order, OpenAPI, Docker deployment, source-security checks, production packaging, and AI-readable CLI outputs.
```
