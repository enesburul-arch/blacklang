...
- [x] Add custom query declarations bound to entities and pages: typed stored-field filters, deterministic sort/limit, generated query lists, permission guards, and AI tooling
