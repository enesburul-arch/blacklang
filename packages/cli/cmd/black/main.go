...
func runDocs(args []string) {
	...
	if !ok {
		result.Errors = []Diagnostic{{
			...
			Suggestion: "Use syntax, version, docs, explain, agent, diagnostics, format, lint, app, auth, role, access, entity, layout, page, table, form, actions, ui, ui-profile, ui-modes, search, filter, paginate, workflow, state, component, blackir, openapi, package, security, audit, or csrf.",
		}}
	}
