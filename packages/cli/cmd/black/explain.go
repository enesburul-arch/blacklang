...
var relatedDocsByKeyword = map[string][]string{
	...
	"csrf":           {"auth", "security"},
	"database":       {"target", "security", "syntax"},
	"deploy":         {"target", "database", "security", "package"},
	"docs":           {"syntax", "explain", "lint", "agent-contract"},
	"entity":         {"page", "table", "form", "component", "computed"},
	"explain":        {"docs", "lint", "syntax"},
	"filter":         {"table", "search", "paginate"},
	"format":         {"lint", "validate"},
	"form":           {"entity", "page", "actions", "view"},
	...
	"table":          {"page", "entity", "computed", "search", "filter", "paginate", "view"},
	"target":         {"deploy", "database", "package"},
	"validate":       {"lint", "format"},
	"version":        {"docs", "lint"},
	"view":           {"page", "layout", "table", "form", "ui"},
